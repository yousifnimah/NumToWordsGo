...
func (Entry EntryUk) getThousandPlural(n int) string {
	mod100 := n % 100
	mod10 := n % 10
...
func (Entry EntryUk) getMillionPlural(n int) string {
	mod100 := n % 100
	mod10 := n % 10
...
func (Entry EntryUk) getBillionPlural(n int) string {
	mod100 := n % 100
	mod10 := n % 10
...
func (Entry EntryUk) getTrillionPlural(n int) string {
	mod100 := n % 100
	mod10 := n % 10
